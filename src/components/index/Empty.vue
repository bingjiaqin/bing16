  ...
  <div class="text" style="text-align: center;">
    <div style="width: 100%;">
      <div style="width: 100%; display: flex; justify-content: center;">
        <div>
          <h1 class="typing-animation">你好，欣喜相逢</h1>
        </div>
      </div>
      <div style="width: 100%; display: flex; justify-content: center;">
        <div class="icons">
          <li><a href="https://github.com/bingjiaqin" target="_blank" rel="noopener noreferrer">
...
.typing-animation {
  ...
  overflow: hidden;
  white-space: nowrap;
  border-right: 0.15em solid #ea5857;
  animation: typing 3s steps(1, start), blink-caret 1s step-end infinite;
}
